...
const TarjetaFondo = ({nombre, ytd, oneyear, threeyear, fiveyear, textoBoton }) => {
  return (
    <div className='flex items-center justify-center p-1 bg-gradient-to-r from-[#00FDA8] to-[#01A78A]  rounded-[20px] md:mr-10 sm:mr-5 mr-0 my-5 xs:min-w-[375px] w-full max-w-[375px]'>
